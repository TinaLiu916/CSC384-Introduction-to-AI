...
if __name__ == '__main__':
    ...
    values = (factor.get_value(['e', 'b']), factor.get_value(['-e', 'b']), factor.get_value(['e', '-b']), factor.get_value(['-e', '-b']))
    if values[0] == FE.get_value(['e'])*FB.get_value(['b']) and values[1] == FE.get_value(['-e'])*FB.get_value(['b']) and values[2] == FE.get_value(['e'])*FB.get_value(['-b']) and values[3] == FE.get_value(['-e'])*FB.get_value(['-b']):
      print("passed.")
    else:
      print("failed.")      
    ...
    values = (factor.get_value(['e', 's', 'b']), factor.get_value(['-e', 's', 'b']), factor.get_value(['e', '-s', '-b']), factor.get_value(['-e', 's', '-b']))
    if values[0] == FE.get_value(['e'])*FS.get_value(['s', 'e', 'b']) and values[1] == FE.get_value(['-e'])*FS.get_value(['s','-e','b']) and values[2] == FE.get_value(['e'])*FS.get_value(['-s','e','-b']) and values[3] == FE.get_value(['-e'])*FS.get_value(['s','-e','-b']):
      print("passed.")
    else:
      print("failed.")      
