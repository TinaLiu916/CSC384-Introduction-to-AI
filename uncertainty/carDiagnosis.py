...
if __name__ == '__main__':
    ...
    # a = [[al, cs, ba, bv, mf, ds, pv, sm, ss, hl, sp,  sq,  cc,  tm,  fs,  af, asys, st],
    # [al, cs, ba, bv, mf, ds, pv, sm, ss, hl,   sp,  sq,  cc,  tm,  fs,  af, asys, st],
    # [al, cs, ba, bv, mf, ds, pv, sm, ss, hl,   sp,  sq,  cc,  tm,  fs,  af, asys, st]]
    ...
    #         prob = VE(car, comb[0], [])
    #         for dom in comb[1].domain():
    #             comb[1].set_assignment(dom)
    #             prob1 = VE(car, comb[0], [comb[1]])
    #             for domm in comb[2].domain():
    #                 comb[2].set_assignment(domm)
    #                 prob2 = VE(car, comb[0], [comb[1], comb[2]])
    #                 if prob1 == prob2 and prob1 != prob:
    #                     print(prob)
    #                     print(prob1)
    #                     print(prob2)
    #                     print("V3: ", comb[0].name)
    #                     print("V2: ", comb[2].name)
    #                     print("V1: ", comb[1].name)
    #                     print("Found!!!")
    ...
    #         if not found1:
    #             found2 = False
    #             for dommm in comb[1].domain():
    #                 comb[1].set_assignment(dommm)
    #                 for domm in comb[2].domain():
    #                     comb[2].set_assignment(domm)
    #                     prob2 = VE(car, comb[0], [comb[1], comb[2]])
    #                     prob3 = VE(car, comb[0], [comb[2]])
    #                     if prob2 == prob3:
    #                         found2 = True
    #             if not found2:
    #                 print(prob)
    ...
    #                 print(prob2)
    #                 print(prob3)
    #                 print("V1: ", comb[0].name)
    #                 print("V2: ", comb[1].name)
    #                 print("V3: ", comb[2].name)
    #                 print("Found!!!")
    ...
    all_comb = [[sq, fs, cc, tm, asys], [al,cs,bv,ss,cc], [ba,bv,ss,cc,fs]]
    # comb = [sq, fs, cc, tm, asys]
    comb = [al, cs, bv, ss, cc]
    # for comb in all_comb:
        # found = False
        # for c in comb:
        ...
        # if not found:
        # prob = VE(car, st, [])
        # for d1 in comb[0].domain():
        #     comb[0].set_assignment(d1)
        #     prob1 = VE(car, st, [comb[0]])
        #     if prob1[0] > prob[0]:
        #         for d2 in comb[1].domain():
        #             comb[1].set_assignment(d2)
        #             prob2 = VE(car, st, [comb[0], comb[1]])
        #             if prob2[0] > prob1[0]:
        #                 for d3 in comb[2].domain():
        #                     comb[2].set_assignment(d3)
        #                     prob3 = VE(car, st, [comb[0], comb[1], comb[2]])
        #                     if prob3[0] > prob2[0]:
        #                         for d4 in comb[3].domain():
        #                             comb[3].set_assignment(d4)
        #                             prob4 = VE(car, st, [comb[0], comb[1], comb[2], comb[3]])
        #                             if prob4[0] > prob3[0]:
        #                                 for d5 in comb[4].domain():
        #                                     comb[4].set_assignment(d5)
        #                                     prob5 = VE(car, st, [comb[0], comb[1], comb[2], comb[3], comb[4]])
        #                                     if prob5[0] > prob4[0]:
        #                                         print(comb[0].name)
        #                                         print(d1)
        #                                         print(comb[1].name)
    ...
    for d1 in comb[0].domain():
        ...
        prob1 = VE(car, st, [comb[0]])
        if prob1[1] < prob[1]:
            print("prob1[1]: ", prob1[1])
            for d2 in comb[1].domain():
                comb[1].set_assignment(d2)
                prob2 = VE(car, st, [comb[0], comb[1]])
                if prob2[1] < prob1[1]:
                    print("prob2[1]: ", prob2[1])
                    for d3 in comb[2].domain():
                        comb[2].set_assignment(d3)
                        prob3 = VE(car, st, [comb[0], comb[1], comb[2]])
                        if prob3[1] < prob2[1]:
                            print("prob3[1]: ", prob3[1])
                            for d4 in comb[3].domain():
                                comb[3].set_assignment(d4)
                                prob4 = VE(car, st, [comb[0], comb[1], comb[2], comb[3]])
                                if prob4[1] < prob3[1]:
                                    print("prob4[1]: ", prob4[1])
                                    for d5 in comb[4].domain():
                                        comb[4].set_assignment(d5)
                                        prob5 = VE(car, st, [comb[0], comb[1], comb[2], comb[3], comb[4]])
                                        if prob5[1] < prob4[1]:
                                            print("prob5[1]: ", prob5[1])
                                            print(comb[0].name)
                                            print(d1)
                                            print(comb[1].name)
                                            print(d2)
